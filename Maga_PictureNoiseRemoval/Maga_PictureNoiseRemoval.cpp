...
// Maga_PictureNoiseRemoval.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMagaPictureNoiseRemovalApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMagaPictureNoiseRemovalApp

CMagaPictureNoiseRemovalApp::CMagaPictureNoiseRemovalApp()
{
...
// Единственный объект CMagaPictureNoiseRemovalApp

CMagaPictureNoiseRemovalApp theApp;


// Инициализация CMagaPictureNoiseRemovalApp

BOOL CMagaPictureNoiseRemovalApp::InitInstance()
{
